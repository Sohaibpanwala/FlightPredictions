...
pd.DataFrame.to_csv(flights,'flights.csv',index=False)




pd.DataFrame.to_csv(passengers,'passengers.csv',index=False)




pd.DataFrame.to_csv(fuel_consumption,'fuel_consumption.csv',index=False)


pd.DataFrame.to_csv(flights_test,'flights_test.csv',index=False)